...
llm = ChatGoogleGenerativeAI(
    ...
    api_key=os.environ.get("GOOGLE_API_KEY")  # ✅ load from env var
)
#llm = ChatGoogleGenerativeAI(model='gemini-2.5-flash', api_key='AIzaSyAvsyNDL52XI1tscQf-hrwgur94Xl5ja2I')
